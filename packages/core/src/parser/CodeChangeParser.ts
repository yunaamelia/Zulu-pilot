...
import { createCodeChangeProposal } from './CodeChangeProposal.js';
...
export class CodeChangeParser {
   ...
   * @returns Array of CodeChangeProposal objects
   */
  parse(response: string, config?: CodeChangeParserConfig): CodeChangeProposal[] {
    ...
    while ((match = codeBlockRegex.exec(response)) !== null) {
      ...
      try {
        ...
        const change = createCodeChangeProposal(
          normalizedPath,
