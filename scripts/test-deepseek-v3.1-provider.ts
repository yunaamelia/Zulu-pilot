#!/usr/bin/env node
/**
 * Test DeepSeek V3.1 using GoogleCloudProvider with region-specific endpoint
 */
...
async function main() {
  console.log('Testing DeepSeek V3.1 with GoogleCloudProvider\n');
  console.log('Configuration: us-west2 region, v1 endpoint, region-specific URL\n');
  ...
  // Create provider with DeepSeek V3.1 config (us-west2 region, v1 endpoint)
  const provider = new GoogleCloudProvider({
    projectId: 'protean-tooling-476420-i8',
    region: 'us-west2', // Region for DeepSeek V3.1
  ...
  console.log(`  Model: deepseek-ai/deepseek-v3.1-maas`);
  console.log(`  Region: us-west2`);
  console.log(`  Endpoint: v1`);
  console.log(`  Endpoint URL: us-west2-aiplatform.googleapis.com (region-specific)`);
